...
export default function OMCPage() {
  ...
  useEffect(() => {
    const fetchOMCDocuments = async () => {
      ...
      try {
        ...
        console.error("Erreur lors du chargement des documents OMC:", error)
      } finally {
        setLoading(false)
      }
    }
  ...
  const breadcrumbItems = [
    ...
    { label: "Organisation Mondiale du Commerce (OMC)", isActive: true }
  ]
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  <div className="w-full flex items-center justify-between px-3 py-2 rounded-md text-sm bg-blue-100 text-blue-700 shadow-sm">
                    <span>Organisation Mondiale du Commerce (OMC)</span>
            ...
            <div className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 lg:py-6">
              <div className="flex flex-col space-y-2 lg:space-y-3">
                <div className="flex items-center text-sm text-gray-500">
                  ...
                  <ChevronRight className="w-4 h-4 mx-2" />
                  <span className="text-gray-900 font-medium">Organisation Mondiale du Commerce (OMC)</span>
                </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm">
                    Aucun document de l'OMC n'est disponible pour le moment.
                  </p>
                </div>
              ) : (
