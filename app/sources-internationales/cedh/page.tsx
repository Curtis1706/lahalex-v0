...
export default function CEDHPage() {
  ...
  useEffect(() => {
    const fetchCEDHDocuments = async () => {
      setLoading(true)
      try {
        ...
        console.error("Erreur lors du chargement des documents CEDH:", error)
      } finally {
        setLoading(false)
      }
    }
  ...
  const breadcrumbItems = [
    ...
    { label: "Convention européenne des droits de l'homme (CEDH)", isActive: true }
  ]
            ...
            <div className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 lg:py-6">
              <div className="flex flex-col space-y-2 lg:space-y-3">
                <div className="flex items-center text-sm text-gray-500">
                  ...
                  <ChevronRight className="w-4 h-4 mx-2" />
                  <span className="text-gray-900 font-medium">Convention européenne des droits de l'homme (CEDH)</span>
                </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm">
                    Aucun document de la CEDH n'est disponible pour le moment.
                  </p>
                </div>
              ) : (
