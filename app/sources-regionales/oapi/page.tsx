...
export default function OAPIPage() {
  ...
  useEffect(() => {
    const fetchOAPIDocuments = async () => {
      setLoading(true)
      try {
        ...
        console.error("Erreur lors du chargement des documents OAPI:", error)
      } finally {
        setLoading(false)
      }
    }
            ...
            <div className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 lg:py-6">
              <div className="flex flex-col space-y-2 lg:space-y-3">
                <div className="flex items-center text-sm text-gray-500">
                  ...
                  <span className="text-gray-900 font-medium">OAPI</span>
                </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm">
                    Aucun document OAPI n'est disponible pour le moment.
                  </p>
                </div>
              ) : (
