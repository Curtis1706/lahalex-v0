...
export default function TextesConstitutionnelsPage() {
  ...
  useEffect(() => {
    const fetchTextesConstitutionnelsDocuments = async () => {
      setLoading(true)
      try {
        const params = new URLSearchParams({
          category: "textes-constitutionnels"
        })
        ...
        console.error("Erreur lors du chargement des textes constitutionnels:", error)
      } finally {
        setLoading(false)
      }
    }

    fetchTextesConstitutionnelsDocuments()
  }, [])
  ...
  const breadcrumbItems = [
    ...
    { label: "Textes constitutionnels et fondamentaux", isActive: true }
  ]
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  <div className="w-full flex items-center justify-between px-3 py-2 rounded-md text-sm bg-blue-100 text-blue-700 shadow-sm">
                    <span>Textes constitutionnels et fondamentaux</span>
            ...
            <div className="bg-white border-b border-gray-200 px-4 lg:px-6 py-4 lg:py-6">
              <div className="flex flex-col space-y-2 lg:space-y-3">
                <div className="flex items-center text-sm text-gray-500">
                  ...
                  <span className="text-gray-900 font-medium">Textes constitutionnels et fondamentaux</span>
                </div>
                <h1 className="text-xl lg:text-2xl font-semibold text-gray-900">
                  Textes constitutionnels et fondamentaux
                </h1>
              </div>
            </div>
              ...
              {loading ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400 text-sm">
                    Aucun texte constitutionnel n'est disponible pour le moment.
                  </p>
                </div>
              ) : (
